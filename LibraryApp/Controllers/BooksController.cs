...
namespace LibraryApp.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Index(string searchString, string category, string availability)
        {
            ...
            // prepare the category list for the dropdown
            ViewBag.Categories = new SelectList(await _context.Books.Select(b => b.Category).Distinct().ToListAsync());
