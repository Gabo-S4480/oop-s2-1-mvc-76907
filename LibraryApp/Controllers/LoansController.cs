...
namespace LibraryApp.Controllers
{
    ...
    public class LoansController : Controller
    {
        ...
        {
            // just show books that are available for loan
        ...
        public async Task<IActionResult> Create([Bind("Id,BookId,MemberId,LoanDate,DueDate,ReturnedDate")] Loan loan)
        {
            ...
            {
                // check if book is already on an active loan 
                ...
                if (activeLoan)
                {
                    ...
                    // reload the lists for the dropdowns
                ...
                // loan aproved, mark the book as unavailable
